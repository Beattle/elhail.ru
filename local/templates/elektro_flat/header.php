 <?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();use Bitrix\Main\Localization\Loc;use Bitrix\Main\Page\Asset;Loc::loadMessages(__FILE__);?><!DOCTYPE html><html lang="<?=LANGUAGE_ID?>">
<head>
<!-- Google Tag Manager -->
...
if ($city["REGION"] == "default") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин (oblikdom.ru)";} 
elseif ($city["REGION"] == "barnaul") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Барнаул";}
elseif ($city["REGION"] == "berezniki") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Березники";}
elseif ($city["REGION"] == "volgograd") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Волгоград";}
elseif ($city["REGION"] == "voronezh") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Воронеж";}
elseif ($city["REGION"] == "dzerzhinsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Дзержинск";}
elseif ($city["REGION"] == "izhevsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Ижевск";}
elseif ($city["REGION"] == "irkutsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Иркутск";}
elseif ($city["REGION"] == "io") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Йошкар-Ола";}
elseif ($city["REGION"] == "kazan") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Казань";}
elseif ($city["REGION"] == "kamensk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Каменск-Уральский";}
elseif ($city["REGION"] == "kemerovo") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Кемерово";}
elseif ($city["REGION"] == "kirov") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Киров";}
elseif ($city["REGION"] == "krasnoyarsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Красноярск";}
elseif ($city["REGION"] == "kurgan") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Курган";}
elseif ($city["REGION"] == "magnitogorsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Магнитогорск";}
elseif ($city["REGION"] == "miass") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Миасс";}
elseif ($city["REGION"] == "nch") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Набережные Челны";}
elseif ($city["REGION"] == "neftekamsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Нефтекамск";}
elseif ($city["REGION"] == "nizhnevartovsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Нижневартовск";}
elseif ($city["REGION"] == "nzhkamsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Нижнекамск";}
elseif ($city["REGION"] == "nnov") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Нижний Новгород";}
elseif ($city["REGION"] == "tagil") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Нижний Тагил";}
elseif ($city["REGION"] == "novokuzneck") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Новокузнецк";}
elseif ($city["REGION"] == "nsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Новосибирск";}
elseif ($city["REGION"] == "noyabrsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Ноябрьск";}
elseif ($city["REGION"] == "omsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Омск";}
elseif ($city["REGION"] == "orenburg") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Оренбург";}
elseif ($city["REGION"] == "orsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Орск";}
elseif ($city["REGION"] == "perm") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Пермь";}
elseif ($city["REGION"] == "rostov") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Ростов-на-Дону";}
elseif ($city["REGION"] == "salavat") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Салават";}
elseif ($city["REGION"] == "sterlitamak") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Стерлитамак";}
elseif ($city["REGION"] == "surgut") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Сургут";}
elseif ($city["REGION"] == "syktyvkar") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Сыктывкар";}
elseif ($city["REGION"] == "tolyatti") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Тольятти";}
elseif ($city["REGION"] == "tomsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Томск";}
elseif ($city["REGION"] == "tmn") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Тюмень";}
elseif ($city["REGION"] == "ulyanovsk") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Ульяновск";}
elseif ($city["REGION"] == "ufa") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Уфа";}
elseif ($city["REGION"] == "cheb") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Чебоксары";}
elseif ($city["REGION"] == "chel") {$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин - Челябинск";}
else
		{$_SESSION["VREGIONS_REGION"]["PRICE"] = "Интернет-магазин (oblikdom.ru)";}
