...
<?php if (!isset($arOption['SEO_URL'])): ?>
  <?=$arOption["VALUE"];?>
<?php else: ?>
  <a title="<?=$arOption["SEO_TITLE"];?>" href="<?=$arOption["SEO_URL"];?>"><?=$arOption["VALUE"];?></a>
<?php endif; ?>
...
<?if($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($arOption["ELEMENT_COUNT"])):?><span class="count" data-role="count_<?=$arOption["CONTROL_ID"]?>"><?=$arOption["ELEMENT_COUNT"]?></span><?endif;?></label>
										</div>
									<?endforeach;
									break;
								default: //CHECKBOXES
