...
foreach($arResult["ITEMS"] as $key => $arElement) {
    ...
    $resPrice = $objPrice->getPrices();
    $arResult['ITEMS'][$key]['CUSTOM_PRICE'] = $resPrice[$arElement['ID']]['DISCOUNT_PRICE']?$resPrice[$arElement['ID']]['DISCOUNT_PRICE']:$arElement['MIN_PRICE']['DISCOUNT_VALUE'];
}
//END_ELEMENTS//
