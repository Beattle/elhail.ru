...
<script type="text/javascript">
	...
	$(function() {
		$("#notify_product_<?=$arParams['NOTIFY_ID']?>").click(function(e){
			...
			$(window).resize();
			$("#notify_body_<?=$arParams['NOTIFY_ID']?>").fadeIn(300);
			$("#notify_<?=$arParams['NOTIFY_ID']?>").fadeIn(300);
		...
		$("#notify_close_<?=$arParams['NOTIFY_ID']?>, #notify_body_<?=$arParams['NOTIFY_ID']?>").click(function(e){
			e.preventDefault();
			$("#notify_body_<?=$arParams['NOTIFY_ID']?>").fadeOut(300);
			$("#notify_<?=$arParams['NOTIFY_ID']?>").fadeOut(300);
		});		
	});
	//]]>
</script>
